...
public class GUIImpl extends JFrame implements GUIInterface {
    ...
    public GUIImpl(NES nes, ButtonChomper bc) {
        this.nes = nes;
        ...
        padController1 = new ControllerImpl(this, nes.getPrefs(), 0, chomps);
        padController2 = new ControllerImpl(this, nes.getPrefs(), 1, chomps);
    ...
    public synchronized void run() {
        //construct window
        this.setTitle("Button Blender 0.1");
        this.setResizable(false);
        buildMenus();
        setRenderOptions();
        
        /*
         * Globel Button Blender keypress actions.
         */
    ...
    public void buildMenus() {
        ...
        file.add(item = new JMenuItem("Open Button Blender Script..."));
        item.addActionListener(listener);
    ...
    public void loadBBScript(){
    	FileDialog fileDialog = new FileDialog(this);
    	fileDialog.setMode(FileDialog.LOAD);
    	fileDialog.setTitle("Select a Button Blender Script!");
    	...
    	if(fileDialog.getFile() != null){
    		...
    		// Start doing Button Spitter stuff.
    	}
    ...
    public class AL implements ActionListener, WindowListener {
        ...
        public void actionPerformed(final ActionEvent arg0) {
            ...
            if (arg0.getActionCommand().equals("Quit")) {
                ...
                messageBox("Button Blender 0.1 [HalfNES " + NES.VERSION + "]"
                        + "\n"
                        + "This version of HalfNES has been hacked for use by the GAP (Game Accessibility Project). \n"
                        + "\n"
                        + "This program is free software licensed under the GPL ver. 3, and comes with \n"
                ...
                loadROM();
            } else if (arg0.getActionCommand().equals("Open Button Blender Script...")) {
            	loadBBScript();
